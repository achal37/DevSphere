    ...
    <>
      ...
      <div className='flex items-center justify-between px-[100px] my-[40px]'>
        ...
        <div className='flex items-center gap-1'>
          ...
          <button onClick={() => { setIsCreateModelShow(true) }} className='bg-blue-500 w-[40px] rounded-[5px] mb-4 text-[20px] !p-[5px] !px-[10px]'>+</button>
        </div>
      </div>
        ...
        <div className="createModelCon fixed top-0 left-0 right-0 bottom-0 w-screen h-screen bg-[rgb(0,0,0,0.1)] flex items-center justify-center">
          <div className="createModel w-[25vw] h-[27vh] shadow-lg shadow-black/50 bg-[#141414] rounded-[10px] p-[20px]">
            ...
            <div className='flex items-center gap-[10px] w-full mt-2'>
              <button onClick={createProj} className='bg-blue-500 rounded-[5px] w-[49%] mb-4 !p-[5px] !px-[10px] !py-[10px]'>Create</button>
